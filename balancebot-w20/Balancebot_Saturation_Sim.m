...
I_r     = 0.004;                 % Inertia of body about center (not wheel axis) Kg*m^2 (TO BE DETERMINED) def = 0.004
...
I_gb    = 100*10^-5;             % inertial of motor armature and gearbox (TO BE DETERMINED)
bot_height  = 25;                % height of the robot in !![cm]!! (TO BE DETERMINED MORE ACCURATELY from wheel center to top)
...
theta_ref = 0.1;                % Reference Body angle value [rad]
...
sim_time = 5;                   % sim time [s] Default = 5
phi_ref = 1;                    % Reference wheel position [rad]
